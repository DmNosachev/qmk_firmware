...
*
* ,--------------------------------------------                           --------------------------------------------.
* |   F1   |HF on |HF off|HF tg |HF dw+|HD dw-|                           |HF fd |HDbuzz|HFcont|ck rst| F11  |  F12   |
* |--------+------+------+------+------+------+                           +------+------+------+------+------+--------|
* |        |      |      |      |      |      |                           |ScrLk |Numlck|  =   |  /   |  *   |        |
* |--------+------+------+------+------+------|                           +------+------+------+------+------+--------|
* |        |      |  MbL |  MUp |  MbR | Ins  |                           |CapsLk|  7   |  8   |  9   |  -   |        |
* |--------+------+------+------+------+------|                           |------+------+------+------+------+--------|
* |        |      |  ML  |  MDn |  MR  |CpsWrd|                           |      |  4   |  5   |  6   |  +   |  L1    |
* |--------+------+------+------+------+------|                           |------+------+------+------+------+--------|
* |        |      |      |      |      |      |                           |  .   |  1   |  2   |  3   |Enter |        |
* `-+------+------+------+------+------+------|                           |------+------+------+------+------+------+-'
*   |      |      |      |      |      |      |                           |      |      |      |      |      |      |
...
*/
[_NM] = LAYOUT_all(
    KC_F1,   HF_ON,   HF_OFF,  HF_TOGG, HF_DWLU, HF_DWLD,   HF_FDBK, HF_BUZZ, HF_CONT, _______, KC_F11,  KC_F12,
    ...
    _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, CW_TOGG,   _______, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, _______,
